...
import { PARAM_TYPES, FAKER_PROVIDERS, GRAPH_OUTPUT_FORMATS } from "./types";
import type { ParamType } from "./types";

const NONE = "__none__";

interface ParamTypeConfigProps {
    paramName: string;
...
export function ParamTypeConfig({ paramName, config, onChange }: ParamTypeConfigProps) {
