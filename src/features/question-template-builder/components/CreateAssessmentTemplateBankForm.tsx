// CreateAssessmentTemplateBankForm - Complete form for creating a new assessment template bank
...
interface CreateAssessmentTemplateBankFormProps {
    title: string;
    description: string;
...
export function CreateAssessmentTemplateBankForm({
    title,
    description,
    selectedFolderId,
    folders,
    ...
    isLoading = false,
    showBackButton = true,
}: CreateAssessmentTemplateBankFormProps) {
