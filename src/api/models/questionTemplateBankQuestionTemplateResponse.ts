...
import type { QuestionTemplateBankQuestionTemplateResponseInputDataConfig } from './questionTemplateBankQuestionTemplateResponseInputDataConfig';
 ...
 */
export interface QuestionTemplateBankQuestionTemplateResponse {
  id: string;
  owner_id: string;
  ...
  input_data_config?: QuestionTemplateBankQuestionTemplateResponseInputDataConfig;
